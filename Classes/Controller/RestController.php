...
class RestController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
    ...
    protected function initializeAction()
    {
        ...
        if (!class_exists($this->entityClassName)) {
            throw new \TYPO3\CMS\Fluid\Exception('The entity class: "' . $this->entityClassName . '" does not exist.', 1475830556);
        }
        ...
        if (!class_exists($this->resourceType)) {
            throw new \TYPO3\CMS\Fluid\Exception('The resource type: "' . $this->resourceType . '" does not exist.', 1475830556);
        }

        $resourceRepositoryClass = str_replace('\Model', '\Repository', $this->resourceType) . 'Repository';
        if (!class_exists($resourceRepositoryClass)) {
            throw new \TYPO3\CMS\Fluid\Exception('The repository: "' . $resourceRepositoryClass . '" for resource of type: "' . $resourceType . '" does not exist.', 1475830556);
        }
